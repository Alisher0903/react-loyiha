...
function Futer() {
  return (
    <div className='mainF'>
      <div className="futr">
        <div className='fList'>
          <Row className='listRow w-100'>
            <Col className='col-3'>
              <Link to="/">
                <img className='mb-5' src="https://solara.uz/resources/img/solara_ru.gif?v=1" alt="slaid" />
              </Link>
              <List type="unstyled">
                <li className='mb-4'>
                  ...
                  Ташкент, Мирабадский район, <span className='ms-4'>Фаргона</span> Йули 222/12
                </li>
                <li className='mb-4'>
            ...
            <Col className='ms-1'>
              <List type="unstyled">
                ...
                <li className='mb-3'>
                  <Link className='linkT' to="https://solara.uz/ru/site/privacy-policy">
                    <span className='slash me-2'>//</span>
                    Privacy Policy
                  </Link>
                </li>
