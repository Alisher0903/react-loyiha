        ...
        <div>
            ...
            <Navbar expand="xl" fixed='top' className='navbar-menu__brend fs-6'>
                <NavbarBrand className='me-5'>
                    <NavLink href="/">
                        <img src="https://solara.uz/resources/img/solara_ru.gif?v=1" alt="navBrend" width={210} />
                    </NavLink>
                </NavbarBrand>
                    ...
                    <Nav className="me-auto" navbar>
                        <NavItem>
                            <NavLink href="/business">
                                {/* <svg xmlns="http://www.w3.org/2000/svg" width="13" viewBox="0 0 16 16">
                                    <path fill="currentColor" d="M16 16L0 0v16z" />
                                </svg> */}
