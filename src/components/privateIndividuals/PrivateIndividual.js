        ...
        <div>
            ...
            <section id="intro">
                <div className="section-intro">
                    <img src="https://solara.uz/assets/images/10/10f22d_Solar-Panels-for-Individuals.jpg" alt="img" />
                    <Container className="text-center">
                        ...
                        <div className="section-intro__icons">
                            <div>
                                <img src="https://solara.uz/assets/images/01/019e13_forindividual-icon1.png" alt="img1" />
                                <img src="https://solara.uz/assets/images/5d/5d4d19_forindividual-icon2.png" alt="img2" />
                                <img src="https://solara.uz/assets/images/cd/cdec56_forindividual-icon3.png" alt="img3" />
                                <img src="https://solara.uz/assets/images/21/21b4c1_forindividual-icon4.png" alt="img4" />
                            </div>
                        </div>
                    </Container>
                </div>
