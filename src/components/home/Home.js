...
function Home() {
    ...
    const items = [
        ...
        <div key={4} className="slider-item ms-4">
            ...
            <div className="read-more-icon" style={{ height: "50%" }}>
            ...
            <div className="blog-content">
                <h3><a href="https://solara.uz/ru/projects/gosudarstvennoe-nalogovoe-upravlenie">Государственное налоговое управление</a></h3>
    ...
    const itemsTwo = [
        <div key={1}>
            <div className="slinder-item ms-4">
